...
\ddefloop ABCDEFGHIJKLMNOPQRSUVWXYZabcdefghijklmnopqrtsuvwxyz\ddefloop
...
\ddefloop ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrtsuvwxyz\ddefloop
\def\ddef#1{\expandafter\def\csname wbar#1\endcsname{\ensuremath{\overline{#1}}}}
\ddefloop ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrtsuvwxyz\ddefloop
...
\def\barV{\ensuremath{\overline{{V}}\hspace{0.0em}}\xspace} 
...
\def\tilth{{\ensuremath{\tilde{\theta}}}}
\def\barVinv{\ensuremath{\overline{{V}}^{-1}}} 
\def\barVi{\ensuremath{\overline{{V}}^{-1}}} 
...
\def\barth{\ensuremath{\wbar{\theta}}\xspace} 
...
\def\err{\mathsf{err}} 
\def\nck#1#2{\begin{pmatrix}#1\\#2  \end{pmatrix}}
\def\Top{\mathsf{Top}}
\def\Bot{\mathsf{Bot}}
\def\bec{\because}
...
%\def\capprox{{\sr{\const}{\approx}}}


%\newcommand{\innerp}[1]{ {\ensuremath{\widehat{#1}}} }
